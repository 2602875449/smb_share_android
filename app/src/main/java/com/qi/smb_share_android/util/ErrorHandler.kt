        ...
        return when (exception) {
            ...
            is IOException -> {
                ...
                when {
                    ...
                    exception.message?.contains("认证", ignoreCase = true) == true -> {
                        AppError.AuthenticationError("用户名或密码错误")
                    }
                    exception.message?.contains("Permission", ignoreCase = true) == true ||
                    exception.message?.contains("权限", ignoreCase = true) == true -> {
                        AppError.PermissionError("没有存储权限，无法完成操作")
                    }
                    exception.message?.contains("Network", ignoreCase = true) == true ||
                    exception.message?.contains("网络", ignoreCase = true) == true -> {
